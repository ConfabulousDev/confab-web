...
import { ClaudeCodeIcon, CodexIcon, CursorIcon, OpenCodeIcon, RobotIcon } from './icons';
...
describe('getProviderIcon', () => {
  ...
  // 6qwh: pins the Cursor mark to cursor sessions.
  it('returns CursorIcon for the canonical cursor provider', () => {
    expect(getProviderIcon('cursor')).toBe(CursorIcon);
  });
