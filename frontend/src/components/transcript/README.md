...
| `claude/ClaudeMessageTimeline.tsx` | (Claude) Virtualized timeline (TanStack Virtual) that renders the Claude transcript. Owns selection/scroll state, search, cost bar; virtual-item building (incl. divider injection) is delegated to `claude/claudeVirtualItems.ts`. Mirror of `codex/CodexMessageTimeline` |
