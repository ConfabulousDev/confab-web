...
- `TrendsResponse.filter_options` (internal `TrendsFilterOptionsSchema`) -- Owner + repo + model dropdown source. Static across active filter changes (mirrors `SessionFilterOptions`).
