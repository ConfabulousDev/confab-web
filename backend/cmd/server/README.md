...
| `SHARE_DAILY_QUOTA` | Per-user cap on shares created in a rolling 24h window (default `100`). The share-creation endpoint returns 429 once exceeded; `0` disables the cap. Invalid/negative values fail startup. |
