			...
			},
			{
				...
				Parts: []OpenCodePart{
					...
					{ID: "prt_01JX0000000000000000000004", Type: "tool", CallID: "call_0", Tool: "Bash",
						State: &OpenCodeToolState{Status: "completed", Input: map[string]any{"command": "ls"}, Output: "file1\nfile2"}},
		...
		{
			{
				...
				Parts: []OpenCodePart{
					{ID: "prt_01", Type: "tool", CallID: "call_0", Tool: "Bash",
						State: &OpenCodeToolState{Status: "completed", Input: map[string]any{"command": "ls"}, Output: "ok"}},
					{ID: "prt_02", Type: "tool", CallID: "call_1", Tool: "Bash",
						State: &OpenCodeToolState{Status: "error", Input: map[string]any{"command": "rm -rf /"}, Error: "permission denied"}},
				},
			},
		},
	}
